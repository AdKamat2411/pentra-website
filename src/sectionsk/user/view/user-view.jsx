...
import ProductSearch from 'src/sectionsk/creators/global-search';

import ProductCard from 'src/sectionsk/creators/creator-card';
import ProductSort from 'src/sectionsk/creators/product-sort';
import FollowerSort from 'src/sectionsk/creators/follower-sort';
import PlatformSort from 'src/sectionsk/creators/platform-sort';
import EngagementSort from 'src/sectionsk/creators/engagement-sort';
import StyleSort from 'src/sectionsk/creators/style-sort';
  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h3">Search All Influencers 🔍</Typography>
